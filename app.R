    ...
    mainPanel(
      ...
      tabsetPanel(type = "tabs",
                  ...
                  tabPanel("Awal Masuk Delta", 
                           ...
                           textOutput("p_4"),
                           br(), 
                           p("Hubungan antara kasus harian covid-19 dengan IHSG cenderung berkorelasi positif karena memiliki pergerakan yang tidak jauh berbeda pada rentang waktu tersebut. Nilai p-value juga masih di bawah nilai 0,05, hal ini berarti jumlah kasus harian dan IHSG masih berkorelasi secara signifikan saat varian Delta masuk Indonesia.")),
                  tabPanel("Gelombang 2 Covid-19", 
                           ...
                           textOutput("p_5"),
                           br(), 
                           p("Dikarenakan kenaikan kasus harian diiringi dengan kecenderungan IHSG yang ikut naik, keduanya pada rentang waktu ini memiliki korelasi positif. Korelasi ini didukung dengan nilai p-value yang di bawah 0,05 yang berarti jumlah kasus harian dan IHSG berkorelasi secara signifikan pada saat gelombang 2.")),
